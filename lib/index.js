...
import { extractAmount, extractClaimNumber, extractSolPublicKey, generateToken, IsAttemptComment, IsBountyComment, isRemoveComment, } from "./lib/utils.js";
export default (app) => {
    app.on("pull_request.closed", async (context) => {
        ...
        if (!transactionDetails) {
            const transactionDetails2 = await sendSolToPublicKey(userWallet.privateKey, contributorSolAddress, parseFloat(BountyIssue.bountyAmount));
